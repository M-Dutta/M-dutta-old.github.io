    ...
    const Name = props => {
        ...
        return (
            <div className="container">
                    <animated.div className="row justify-content-center" style={{...styleName, ...animationTop}}>Hi!</animated.div>
                    <animated.div className="row justify-content-center"  style={{...styleName, ...animationBottom}}>I'm Mishuk</animated.div>
                </div>
        )
    }
